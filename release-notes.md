...
- Feature
  - Add API Utxodex.inscribeTransfer(ticker:string, amount:string)
...
- Domain resolution related
  - Add domain name resolution of .Utxodex
...
- The displaying layout of NFTs in the extension is updated to match the layout on https://Utxodex.com/
